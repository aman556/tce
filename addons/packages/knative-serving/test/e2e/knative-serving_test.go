...
var _ = Describe("knative-serving Addon E2E Test", func() {
	/*Specify("check knative-serving is running", func() {
	var result int
	...
	for {
		resp, _ := http.Get(cmdHelperUp.CommandArgs["knative-serving-health-check"][1])
		if resp != nil {
