...
cp -f "${ROOT_CORE_ARTFACTS_DIR}/linux/amd64/cli/package/${CORE_BUILD_VERSION}/tanzu-package-linux_amd64" "${PACKAGE_LINUX_AMD64_DIR}/bin/tanzu-plugin-package"
...
cp -f "${ROOT_CORE_ARTFACTS_DIR}/darwin/amd64/cli/package/${CORE_BUILD_VERSION}/tanzu-package-darwin_amd64" "${PACKAGE_DARWIN_AMD64_DIR}/bin/tanzu-plugin-package"
